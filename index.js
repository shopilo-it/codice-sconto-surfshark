 ...
 * Homepage: https://shopilo.it/negozi/surfshark.com
 */

const SHOPILO_URL = "https://shopilo.it/negozi/surfshark.com";
const STORE_NAME  = "Surfshark";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-surfshark)" }
  });
