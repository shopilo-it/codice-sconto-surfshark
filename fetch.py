#!/usr/bin/env python3
"""
Recupero codici sconto Surfshark da shopilo.it
Sursa: https://shopilo.it/negozi/surfshark.com
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/surfshark.com"
STORE_NAME = "Surfshark"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Surfshark da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-surfshark)"
    }
    try:
